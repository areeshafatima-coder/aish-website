...
const collectionMeta: Record<string, { title: string; description: string; keywords: string[] }> = {
  ...
  "bridal-occasion": {
    title: "Pakistani Bridal Lehengas UK — Bespoke Nikkah, Walima & Wedding Occasion Wear | Aish",
    description:
      "Bespoke Pakistani bridal lehengas made to your measurements — nikkah, walima, rukhsati, mehndi & baraat. Every piece designed specifically for you. UK & US.",
    keywords: [
      ...
      "custom bridal lehenga uk",
      "made to order bridal lehenga uk",
      "designer pakistani bridal uk",
      "pakistani wedding occasion wear uk",
      "luxury bridal lehenga uk",
