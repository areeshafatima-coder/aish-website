...
export const products: Product[] = [
  {
    ...
    image: `${ASSETS}/sage-reverie-couture-gown-1.webp`,
    images: [
      `${ASSETS}/sage-reverie-couture-gown-1.webp`,
    ],
    badge: "New",
  ...
  },
  {
    ...
    image: `${ASSETS}/champagne-gold-lehenga-hero.webp`,
    images: [`${ASSETS}/champagne-gold-lehenga-hero.webp`],
    badge: "New",
  ...
  },
  {
    ...
    image: `${ASSETS}/lavender-embroidered-lehenga-hero.webp`,
    images: [`${ASSETS}/lavender-embroidered-lehenga-hero.webp`],
  ...
  },
  {
    ...
    image: `${ASSETS}/maroon-velvet-embroidered-outfit-hero.webp`,
    images: [`${ASSETS}/maroon-velvet-embroidered-outfit-hero.webp`],
    badge: "Bestseller",
  ...
  },
  {
    ...
    image: `${ASSETS}/royal-maroon-bridal-lehenga-hero.webp`,
    images: [
      `${ASSETS}/royal-maroon-bridal-lehenga-hero.webp`,
    ],
    badge: "Couture",
    whatsappText:
  ...
  // ——— Inspired by your references (festive, luxe campaign look) ———
  {
    ...
    image: `${ASSETS}/periwinkle-silver-lehenga-1.webp`,
    images: [`${ASSETS}/periwinkle-silver-lehenga-1.webp`],
    badge: "Bestseller",
  ...
  },
  {
    ...
    image: `${ASSETS}/mint-silver-ensemble-1.webp`,
    images: [
      `${ASSETS}/mint-silver-ensemble-1.webp`,
      `${ASSETS}/mint-silver-ensemble-opt4.webp`,
      `${ASSETS}/mint-silver-ensemble-opt5.webp`,
      `${ASSETS}/mint-silver-ensemble-opt6.webp`,
      `${ASSETS}/mint-silver-ensemble-opt7.webp`,
    ],
  ...
  },
  {
    ...
    image: `${ASSETS}/dusky-train-exact-threequarter-back.webp`,
    images: [
      `${ASSETS}/dusky-train-exact-threequarter-back.webp`,
      `${ASSETS}/dusky-train-exact-front.webp`,
      `${ASSETS}/dusky-train-exact-side.webp`,
      `${ASSETS}/dusky-train-exact-back.webp`,
      `${ASSETS}/dusky-train-exact-angle-left.webp`,
      `${ASSETS}/dusky-train-exact-6.webp`,
      `${ASSETS}/dusky-train-exact-7.webp`,
      `${ASSETS}/dusky-train-exact-8.webp`,
      `${ASSETS}/dusky-train-exact-9.webp`,
      `${ASSETS}/dusky-train-exact-10.webp`,
      `${ASSETS}/dusky-train-exact-11.webp`,
      `${ASSETS}/dusky-train-exact-12.webp`,
    ],
    badge: "New",
  ...
  },
  {
    ...
    image: `${ASSETS}/slate-blue-couture-lehenga-1.webp`,
    images: [
      `${ASSETS}/slate-blue-couture-lehenga-1.webp`,
      `${ASSETS}/slate-blue-couture-lehenga-3.webp`,
      `${ASSETS}/slate-blue-couture-lehenga-4.webp`,
      `${ASSETS}/slate-blue-couture-lehenga-5.webp`,
      `${ASSETS}/slate-blue-couture-lehenga-close2.webp`,
    ],
    badge: "New",
  ...
  },
  {
    ...
    image: `${ASSETS}/slate-blue-slim-lehenga-dupatta-front.webp`,
    images: [
      `${ASSETS}/slate-blue-slim-lehenga-dupatta-front.webp`,
      `${ASSETS}/slate-blue-slim-lehenga-dupatta-fronton.webp`,
      `${ASSETS}/slate-blue-slim-lehenga-dupatta-back.webp`,
      `${ASSETS}/slate-blue-slim-lehenga-dupatta-close.webp`,
    ],
    badge: "New",
  ...
  // ——— Premium open gown: blush pink & silver ———
  {
    ...
    image: `${ASSETS}/product-blush-silver-gown-1.webp`,
    images: [
      `${ASSETS}/product-blush-silver-gown-1.webp`,
      `${ASSETS}/product-blush-silver-gown-2.webp`,
      `${ASSETS}/product-blush-silver-gown-3.webp`,
    ],
    badge: "New",
...
export const collections: Collection[] = [
  { slug: "luxury-pret", name: "Luxury Pret", image: `${ASSETS}/collection-luxury-pret-modern-v4.webp`, cta: "Explore", large: true },
  { slug: "festive", name: "Festive", image: `${ASSETS}/collection-fit-festive-modern-1.webp`, cta: "Shop" },
  { slug: "formal", name: "Formal", image: `${ASSETS}/banner-blush-gold-editorial.webp`, cta: "Shop" },
  { slug: "bridal-occasion", name: "Bridal & Occasion", image: `${ASSETS}/collection-bridal-occasion-modern-v3a.webp`, cta: "Discover" },
];

export const heroSlides: HeroSlide[] = [
  {
    image: `${ASSETS}/aish-banner-2-hq.webp`,
    tag: "Bridal & Occasion",
    title: "Made for You.\nOnly You.",
    subtitle: "Every piece handcrafted to your measurements. Never duplicated.",
  },
  {
    image: `${ASSETS}/aish-banner-3-hq.webp`,
    tag: "Bridal Couture",
    title: "A Dress as\nUnique as You.",
    subtitle: "Nikkah. Walima. Rukhsati. Every occasion, crafted with intention.",
  },
  {
    image: `${ASSETS}/aish-banner-couple-maroon.webp`,
